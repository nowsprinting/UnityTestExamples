...
namespace APIExamples.NUnit
{
    ...
    /// <p/>
    /// 組み合わせ生成ルールのデフォルトは全組み合わせ網羅です。明示的に全組み合わせ網羅であることを示すには <see cref="CombinatorialAttribute"/> を使用できます。
    ...
    /// </remarks>
    /// <seealso cref="ValueSourceAttributeExample"/>
    [TestFixture]
    ...
    public class ValuesAttributeExample
    {
        ...
        public void GetDamageMultiplier_無属性からの攻撃はすべて等倍ダメージ(
            [Values] Element defence, // Note: enumおよびbool型に対してValue属性の引数を省略したときはすべての値が渡されます
        ...
        public void GetDamageMultiplier_ParametrizedIgnore属性で等倍ダメージにならない組み合わせを除外_すべて等倍ダメージ(
            // Note: ParametrizedIgnore 属性は Unity Test Framework v1.4 で追加された属性です
